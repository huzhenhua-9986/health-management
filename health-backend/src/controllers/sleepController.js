...
export async function getList(req, res) {
  try {
    ...
    const result = await SleepData.getList({
      user_id,
      start_date,
      end_date,
...
export async function create(req, res) {
  try {
    ...
    const record = await SleepData.create(data)
...
export async function getOne(req, res) {
  try {
    const record = await SleepData.findById(req.params.id)
...
export async function update(req, res) {
  try {
    ...
    const updated = await SleepData.update(req.params.id, req.body)
...
export async function remove(req, res) {
  try {
    ...
    await SleepData.delete(req.params.id)
